...
public class CalculatePrice {
    ...
    PriceFacade p = new PriceFacade("pu");
    ...
    public String[] carrierNames = {"Fedex Economy", "Fedex Priority", "UPS Saver", "Ups Express", "Ups Standard", "GLS"};
    PriceFacade pg = new PriceFacade("pu");
    ...
    public PriceOBJ getPrice(String country, String kgString) {
        ...
        return new PriceOBJ(kg1, fedexE, fedexP, upsSa, upsE, upsSt, glsS, carrierNames[cheapest]);
    }
}
